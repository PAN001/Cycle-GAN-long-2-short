...
tf.flags.DEFINE_string('X_input_dir', 'data/Leggings2shorts/trainA',
                       'X input directory, default: data/Leggings2shorts/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/Leggings2shorts/trainB',
                       'Y input directory, default: data/Leggings2shorts/trainB')
